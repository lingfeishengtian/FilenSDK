...
final class FilenUtils : Sendable {
  ...
  func orderedJSONString (from value: Any) -> String? { // We need this dirty function to be compatible with JavasScript's JSON.parse()
    ...
    func copyOffset (from sourceURL: URL, to targetURL: URL, offset: Int64) throws {
        try autoreleasepool {
    ...
    @available(*, deprecated, renamed: "copyOffset", message: "Use async copyOffset instead")
...
// we use withCheckedThrowingContinuation and always keep thread safety in mind
